	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="attence/informationAdd" method="POST"
					...
					<ul class="forminfo">
						...
						<li><label>打卡时间<b>*</b></label><input id="attence_date" 
							name="attence_date" type="text" class="dfinput"
							style="width: 518px;" /></li>	
						<li><label>上班时间<b>*</b></label><input id="start_time" 
							name="start_time" type="text" class="dfinput"
							style="width: 518px;" /></li>	
						<li><label>下班时间<b>*</b></label><input id="end_time" 
							name="end_time" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>备注<b>*</b></label><textarea id="content7" name="remark"></textarea></li>	
...
var attence_date = {
		...
		laydate(attence_date);
    var checkSubmitFlg = false; 
    function checkSubmit() { 
      if (checkSubmitFlg == true) { 
         return false; 
      } 
      var attence_date = $("#attence_date").val();
      var start_time = $("#start_time").val();
      var end_time = $("#end_time").val();
        if(!$.trim(attence_date)){
			alert('请输入打卡时间!');
			return false;
		}
		if(!$.trim(start_time)){
