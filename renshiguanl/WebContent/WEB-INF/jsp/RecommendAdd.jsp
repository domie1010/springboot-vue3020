	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="recommend/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>部门名称<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写部门名称"
							style="width: 518px;" /></li>
						<li><label>部门描述<b>*</b></label><textarea id="content7" name="remark"></textarea></li>
