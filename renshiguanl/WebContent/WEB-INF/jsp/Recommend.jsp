	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="recommend/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
						<input type="hidden" name="id" value="${recommend['id']}">
					<ul class="forminfo">
						<li><label>部门名称<b>*</b></label><input id="name" value="${recommend['name'] }"
							name="name" type="text" class="dfinput" placeholder="请填写部门名称"
							style="width: 518px;" /></li>
						<li><label>部门描述<b>*</b></label><textarea id="content7" name="remark">${recommend['remark'] }</textarea></li>
